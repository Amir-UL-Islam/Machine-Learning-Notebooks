...
print('x << y =', x << y) # Returns x with the bits shifted to the left by y places 
              # (and new bits on the right-hand-side are zeros). 
              # This is the same as multiplying x by 2**y.
print('where x = {}, y = {}'.format(x, y))
print('Row calculation of x << y = {}'.format('2 * 2**3'))
        
x = 6
y = 2
print('x >> y =', x >> y) # Returns x with the bits shifted to the right by y places.
...
x = 1
y = 0
print('x & y =', x & y) # Does a "bitwise and".
            # Each bit of the output is 1 if the corresponding bit of x AND of y is 1,
            # otherwise it's 0.
        

print('x | y =', x | y) # Does a "bitwise or".
                        # Each bit of the output is 0 if the corresponding bit of x AND of y is 0, 
                        # otherwise it's 1.
        
print('~x =', ~x) # Returns the complement of x - the number you get by switching each 1 for a 0 and 
                  # each 0 for a 1.
                  # This is the same as -x - 1.
x = 2
y = 6
print('x ^ y', x ^ y) # Does a "bitwise exclusive or".
